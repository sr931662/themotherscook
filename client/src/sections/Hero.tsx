...
import coverImg from '../assets/the mothers cook cover.jpg'
      ...
      <div className={styles.heroInner}>
        <div className={styles.heroImg}>
          <PlaceholderPhoto
            ...
            src={coverImg}
            alt="The Mothers Cook sealed meal box with paneer, dal, rice and roti"
            width={1672}
            height={941}
          />
        ...
        <div className={styles.inner}>
          <div className={styles.copy}>
            ...
            <p className={styles.lead}>
              Premium vegetarian catering for Grihapravesh, Pooja, family gatherings, corporate
              events and more. Cooked fresh, packaged with care and delivered at scale — so you can
              focus on your moments, we&rsquo;ll take care of the food.
            </p>
